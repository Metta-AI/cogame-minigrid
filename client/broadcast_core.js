...
// pixel is baked server-side (src/minigrid/global.nim) and arrives as sprite
// definitions plus retained-mode object placements. The only edit is the wire
// constants namespace, `window.CTF_WIRE` -> `window.MINIGRID_WIRE`, emitted by
// tools/gen_wire_constants.nim. tests/test_minigrid_viewer.nim pins the kept
...
(function() {
  ...
  const CHROME_SPRITE_ID =
    (window.MINIGRID_WIRE && window.MINIGRID_WIRE.chromeSpriteId) || 4090;
